...
/*
Problem: Touchables will activate onPressOut when dragged, sometimes you don't
want that.

Solution: This component tracks a drag threshold, sets a disabled state, and
call onPressOut on release if it is not disabled.
*/
